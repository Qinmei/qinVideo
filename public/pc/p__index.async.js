(window["webpackJsonp"]=window["webpackJsonp"]||[]).push([[12],{QeBL:function(e,t,a){"use strict";a.r(t);var n=a("p0pE"),i=a.n(n),o=a("mrSG"),r=a("q1tI"),l=a.n(r),c=a("XfOM"),s=a.n(c),d=(a("fV52"),a("3I+P")),p=a("qIgq"),u=a.n(p),m=a("usdK"),g=a("vOnD"),h=g["a"].div`
  width: 100%;
  display: grid;
...
`,v=e=>{var t=e.value,a=t.scroll,n=void 0===a?[]:a,i=t.top,o=void 0===i?[]:i,c=t.type,s=void 0===c?"animate":c,p=Object(r["useState"])(200),g=u()(p,2),v=g[0],f=g[1],x=Object(r["useRef"])(null),w=e=>{m["a"].push(`/${s}/${e}`)};return Object(r["useEffect"])(()=>{f(x.current.clientHeight)}),l.a.createElement(h,null,l.a.createElement("div",{className:"scroll",ref:x},l.a.createElement(d["a"],{autoplay:!0,autoplaySpeed:5e3,adaptiveHeight:!0},n.slice(0,6).map(e=>l.a.createElement(b,{height:v,style:{backgroundImage:`url(${e.cover.horizontal})`},onClick:()=>{w(e.slug)}},l.a.createElement("span",null,e.title))))),o.slice(0,6).map(e=>l.a.createElement("div",{className:"top",style:{backgroundImage:`url(${e.cover.horizontal})`},onClick:()=>{w(e.slug)}},l.a.createElement("span",null,e.title))))},f=v,x=a("mNhR"),w=a("bdvc"),E=a("XEok"),y=g["a"].div`
