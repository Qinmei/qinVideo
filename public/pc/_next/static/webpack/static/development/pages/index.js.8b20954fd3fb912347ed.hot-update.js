...
var reactComponent = function reactComponent(props) {
  ...
  var goCategory = function goCategory(ele) {
    if (ele.status === "custom") {
      ...
      next_router__WEBPACK_IMPORTED_MODULE_4___default.a.push("/".concat(ele.type, "/").concat(ele.kind.slice(1), "/").concat(ele._id));
    }
  };
...
//# sourceMappingURL=index.js.8b20954fd3fb912347ed.hot-update.js.map