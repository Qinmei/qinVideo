...
(function () {
  ...
  function B(a, b) {
    function d(b, d, f) {
      ...
      f && (c = f.width / e, e = f.height / e, 128 < e && (c /= e / 128, e = 128), 48 <= c && 48 <= e && (b.drawImage(f, c / -2, e / -2, c, e), b.translate(0, e / 2 + 32)));
      b.fillText(v, k / -2, 0);
    ...
    E && (c('msapplication-starturl', a.start_url || '/'), c('msapplication-TileColor', a.theme_color));
    document.head.querySelector('[name="theme-color"]') || c('theme-color', a.theme_color);
    var h = F(a.orientation);
    c('x5-orientation', h);
    c('screen-orientation', h);
    'fullscreen' === q ? (c('x5-fullscreen', 'true'), c('full-screen', 'yes')) : g && (c('x5-page-mode', 'app'), c('browsermode', 'application'));
      ...
      if (x.length) {
        ...
        l.onload = function () {
          ...
          if (a.background_color) {
            ...
            null !== b && (m.href = b, x.slice(1).forEach(function (b) {
              var d = new Image();
  ...
  function D(a) {
    if (p || H) {
      var b = y(a);
      if (p) c('apple-mobile-web-app-status-bar-style', b ? 'black' : 'default');else {
        try {
        ...
        null === d ? console.debug('UWP no titleBar') : (d.foregroundColor = r(b ? 'black' : 'white'), d.backgroundColor = r(a));
      }
    }
  }
