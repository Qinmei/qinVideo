(window["webpackJsonp"]=window["webpackJsonp"]||[]).push([[6],{"8S6H":function(e,t,a){"use strict";a.r(t);a("R9oj");var n=a("ECub"),l=(a("miYZ"),a("tsqr")),r=a("mrSG"),i=a("q1tI"),s=a.n(i),o=a("MuoO"),c=a("qIgq"),m=a.n(c),p=(a("Znn+"),a("ZTPi")),d=a("vOnD"),u=a("XEok"),g=a("LLXN"),h=a("yDSA"),b=(a("T2oS"),a("W9HT")),f=a("Dp36"),E=a("wd/R"),y=a.n(E),v=a("bdvc"),x=e=>{var t=Math.floor(e/60),a=Math.floor(e%60);return`${Object(v["a"])(t)}:${Object(v["a"])(a)}`},j=d["a"].div`
...
`,w=e=>{var t=e.id,a=Object(i["useContext"])(u["a"]),n=Object(i["useMemo"])(()=>a,[a]),l=Object(i["useState"])([]),r=m()(l,2),o=r[0],c=r[1],p=Object(i["useState"])(!0),d=m()(p,2),h=d[0],E=d[1];return Object(i["useEffect"])(()=>{f["a"].queryDanmu({query:{id:t}}).then(e=>{c(e.data),E(!1)})},[e.id]),s.a.createElement(j,{color:n},s.a.createElement("div",{className:"head"},s.a.createElement("span",null,Object(g["formatMessage"])({id:"danmu.time"})),s.a.createElement("span",null,Object(g["formatMessage"])({id:"danmu.content"})),s.a.createElement("span",null,Object(g["formatMessage"])({id:"danmu.created"}))),s.a.createElement(b["a"],{spinning:h},s.a.createElement("div",{className:"main"},o.map(e=>s.a.createElement("div",{className:"list"},s.a.createElement("span",null,x(e.time)),s.a.createElement("span",null,e.text),s.a.createElement("span",null,y()(e.createdAt).format("MM-DD")))))))},O=w,k=a("8KYf"),N=a("mNhR"),M=a("usdK"),$=a("eNRF"),D=(a("Quhn"),a("NUga")),I=a.n(D),S=a("ulZh"),q=a.n(S),z=e=>{var t=e.target,a=e.info,n=e.type,l=Object(i["useContext"])(u["a"]),r=Object(i["useMemo"])(()=>l,[l]);window.Hls=q.a;var o=e=>{var t=e.color,a=e.id,n=e.link,l=e.type,r=window.config.dplayer||"http://api.btstu.cn/sjbz/?lx=dongman",i={container:document.getElementById("dplayer"),autoplay:!0,theme:t,screenshot:!1,hotkey:!0,preload:"auto",volume:.7,mutex:!0,video:{url:n,pic:r,type:"mp4"===l?"auto":"hls"},danmaku:{id:a,api:"/api/v1/danmu/list/",maximum:1e3,bottom:"15%",unlimited:!0}};new I.a(i)};return Object(i["useEffect"])(()=>{"php"!==n&&o({color:r,id:t,link:a.link,type:n})},[e.target]),s.a.createElement(s.a.Fragment,null,"php"===n?s.a.createElement("iframe",{style:{width:"100%",height:"100%",border:"none"},src:a.link}):s.a.createElement("div",{id:"dplayer"}))},C=z,P=a("l61h"),R=p["a"].TabPane,F=d["a"].div`
  .player {
    margin-top: 40px;
    z-index: 999;
